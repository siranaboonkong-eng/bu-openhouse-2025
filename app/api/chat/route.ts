...
const userData = {
  ...
  role: "Kuyyai city",
  skills: [
    "Kuyyai", "Kaiyai", "More sparm", "Sigma", "Butterbear", 
  ],
  education: [
    {
      school: "Kuy",
...
const systemPrompt = ` Your Name is "Juyaikailek" , You are my personal AI assistant representing their professional portfolio. 
